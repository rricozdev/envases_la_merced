...
const SucursalPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Envases PET al Mayoreo en {sucursal.name} | Envases La Merced
        </title>
        <meta
          name="description"
          content={`Compra envases PET al mayoreo en nuestra sucursal de ${sucursal.name}. Botellas, frascos y tapas para alimentos, cosméticos y limpieza. ${sucursal.address}.`}
        />
        <link
          rel="canonical"
          href={`https://envaseslamerced.mx/sucursales/${sucursal.path}`}
        />
      </Helmet>
