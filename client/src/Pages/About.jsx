...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Quiénes Somos — Distribuidor de Envases PET | Envases La Merced
        </title>
        <meta
          name="description"
          content="Conoce a Envases La Merced, distribuidor mayorista de envases PET con sucursales en CDMX, Puebla, Veracruz, Nezahualcóyotl y Querétaro."
        />
        <link
          rel="canonical"
          href="https://envaseslamerced.mx/sobre-nosotros"
        />
      </Helmet>
