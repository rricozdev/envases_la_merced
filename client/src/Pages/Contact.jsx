...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contacto y Cotización de Envases PET | Envases La Merced</title>
        <meta
          name="description"
          content="Solicita tu cotización de envases PET al mayoreo. Contáctanos por WhatsApp, teléfono o correo. Respondemos a toda la República Mexicana."
        />
        <link rel="canonical" href="https://envaseslamerced.mx/contacto" />
      </Helmet>
